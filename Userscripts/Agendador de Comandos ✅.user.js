    ...
    if (data === "Sem permissão") {
        ...
        if (data.expireInTwoDays) {
            UI.Notification.show(
                ...
                `Sua licença do Agendador de Comandos está expirando em: ${data.remainingTime.days} dias, ${data.remainingTime.hours} horas, e ${data.remainingTime.minutes} minutos`,
