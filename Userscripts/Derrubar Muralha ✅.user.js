...
$.ajax({
    url: "https://api-users.herokuapp.com/api/user/auth/muralha",
    type: "POST",
    ...
    if (data === "Sem permissão") {
        ...
        if (data.expireInTwoDays) {
            UI.Notification.show(
                ...
                `Sua licença do Derrubar Muralha está expirando em: ${data.remainingTime.days} dias, ${data.remainingTime.hours} horas, e ${data.remainingTime.minutes} minutos`,
