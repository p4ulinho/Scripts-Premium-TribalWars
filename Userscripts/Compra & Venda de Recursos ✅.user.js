// ==UserScript==
// @name         Compra & Venda de Recursos ✅
// @author       PaulinhoTutoriais
// @include      **exchange*
// @include      **market*
// @exclude      **call*
// @exclude      **mass_create_offers*
    ...
    if (data === "Sem permissão") {
        ...
        if (data.expireInTwoDays) {
            UI.Notification.show(
                ...
                `Sua licença do Compra & Venda de Recursos está expirando em: ${data.remainingTime.days} dias, ${data.remainingTime.hours} horas, e ${data.remainingTime.minutes} minutos`,
