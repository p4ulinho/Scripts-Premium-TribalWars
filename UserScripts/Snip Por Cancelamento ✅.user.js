    ...
    if (data === "Sem permissão") {
        ...
        if (data.expireInTwoDays) {
            UI.Notification.show(
                ...
                `Sua licença do Snip por Cancelamento Automático está expirando em: ${data.remainingTime.days} dias, ${data.remainingTime.hours} horas, e ${data.remainingTime.minutes} minutos`,
